...
def not_found(e):
    return '❄️❄️❄️Нет такой страницы, вернуться обратно <a href="/menu">Меню</a> ❄️❄️❄️', 404
...
def new_year_card():
    ...
    return render_template('lab9/new_year_card_form.html')
...
def show_card():
    ...
    card_text = f"С Новым Годом, {recipient_name}! Желаю быть счастлив{'ой' if recipient_gender == 'female' else 'ым'} в Новом году! С наилучшими пожеланиями, {sender_name}."

    return render_template('lab9/show_card.html', card_text=card_text)